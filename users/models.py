...
class User(AbstractUser):
    ...
    language = models.CharField(choices = LANGUAGE_CHOCIES, max_length=2, blank=True, default=LANGUAGE_KOREAN)
    ...
    def verify_email(self):
        ...
        if self.email_verified is False:
            ...
            send_mail("verify blab la", strip_tags(html_message), settings.EMAIL_FROM, [self.email], fail_silently=True, html_message=html_message)
            self.save()
        return
